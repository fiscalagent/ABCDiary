...
<ol>
  <li>Нажмите <strong>+</strong> и выберите тип записи: <em>Эмоция</em> (ситуация, мысли, эмоции, поведение) или <em>Дело</em> (занятие и оценки).</li>
  <li>Нажмите на поле и говорите вслух — речь переводится в текст автоматически. Можно и печатать.</li>
  <li>Сохраните запись — она уйдёт в таблицу и останется на устройстве в зашифрованном виде.</li>
</ol>
      ...
      <div className="form-body help-body">
        ...
        <section className="help-section">
          ...
          <div className="help-card">
            <h3>Ежедневная работа</h3>
            <ol>
              <li>Нажмите <strong>+</strong> и выберите тип: <em>Эмоция</em> или <em>Дело</em>.</li>
